...
def test_update_transaction(logged_client, test_transactions, test_categories):
    updated_trans = {
        "title": "new_title",
        "amount": 20000,
...
def test_update_transaction_non_existent(logged_client, test_transactions, test_categories):
    updated_trans = {
        "title": "new_title",
        "amount": 20000,
...
def test_update_transaction_not_allowed(test_users, logged_client, test_transactions, test_categories):
    other_users_transactions = [
        trans for trans in test_transactions if trans.user_id != test_users[0]["id"]
    ]
    updated_trans = {
